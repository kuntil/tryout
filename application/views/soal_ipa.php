<html lang="en">
    ...
    <div class="container-fluid">
      <div class="row-fluid">
          <?php echo form_open('c_pengerjaan/simpanIpa','name="form_soal" id="form_soal"')?>
          <div class="clearfix"></div>
          <div class="row-fluid">
              <ul class="thumbnails">
                  <li class="span12">
                      <div class="thumbnail">
                          <h4 class="text-success"><center>Soal IPA</center></h4>
                      </div>
                  </li>
              </ul>
          </div>
                      ...
                      <div class="thumbnail">
                          <table cellpadding="10" rowpadding="10" class="table-striped">
                              ...
                              <tr>
                                  ...
                                  <td></td>
                                  <td> 										
                                      <input type="hidden" name="soal[<?php echo $i?>]" value="<?php echo $row->id_soal?>"/>
								</td>
                              </tr>
                              <?php $i++; endforeach;?>
                          </table>
