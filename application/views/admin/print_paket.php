	...
	<h3>Daftar Soal</h3>
        <table class="data">
			...
			<tr class="data">
				...
				<center>
                                    <a href="./c_print/cetak/<?php echo $row->kd_soal ?>" target="_blank"><img src="<?php echo base_url(); ?>mos-css/img/oke.png"></a>&nbsp;&nbsp;&nbsp;
        ...
        <input class="button" type="submit" name="submit" value="Tampilkan">
        </p>
        <?php echo form_close(); ?>
	</div>
<div class="clear"></div>
