	...
	<h3>Daftar Tentor</h3>
		...
		<table class="data">
			...
			<tr class="data">
				...
				<td class="data"><?php echo $row->jam?></td>
                                <td class="data" width="75px">
				<center>
				<a href="./c_konsul/edit/<?php echo $row->id_jadwal ?>"><img src="<?php echo base_url(); ?>mos-css/img/oke.png"></a>&nbsp;&nbsp;&nbsp;
				<a href="./c_konsul/delete/<?php echo $row->id_jadwal ?>"><img src="<?php echo base_url(); ?>mos-css/img/detail.png"></a>
				</center>
				</td>
