	...
	<h3>Daftar User Terdaftar</h3>
		...
		<table class="data">
			...
			<tr class="data">
				...
				<td class="data"><center><?php echo $row->sekolah;?></center></td>
				<td class="data"><center><?php echo $row->kelas;?></center></td>
				<td class="data"><center><?php echo $row->status;?></center></td>
                                <td class="data" width="100px">
				<center>
				<a href="./c_user/universitas/<?php echo $row->id_user; ?>"><img src="<?php echo base_url(); ?>mos-css/img/jurusan.png"></a>&nbsp;&nbsp;&nbsp;
				<a href="./c_user/delete/<?php echo $row->id_user; ?>"><img src="<?php echo base_url(); ?>mos-css/img/oke.png"></a>&nbsp;&nbsp;&nbsp;
				<a href="./c_user/select/<?php echo $row->id_user; ?>"><img src="<?php echo base_url(); ?>mos-css/img/detail.png"></a>
				</center>
				</td>
