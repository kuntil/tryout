	...
	<h3>Daftar User Login</h3>
		...
		<table class="data">
			...
			<tr class="data">
				...
				<th class="data">Tgl Login</th>
				<th class="data">Ip Address</th>
				<th class="data">Session</th>
				<th class="data">Status</th>
                    ...
                    <tbody>
                        <?php
                            $i=1;
                            foreach($usr_login->result() as $row) :
                        ?>
			<tr class="data">
                            
				<td class="data"><center><?php echo $i; ?></center></td>
				<td class="data"><center><?php echo $row->usrname; ?></center></td>
				<td class="data"><center><?php echo $row->usrlogin;?></center></td>
				<td class="data"><center><?php echo $row->usrip;?></center></td>
				<td class="data"><center><?php echo $row->usrsession;?></center></td>
				<td class="data"><center><?php echo $row->usrstatus;?></center></td>
			</tr>
                    </tbody>
                        <?php
                            $i++;
