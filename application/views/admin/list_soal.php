...
<link rel="shortcut icon" href="<?php echo base_url(); ?>mos-css/img/devil-icon.png"> 
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>mos-css/mos-style.css"> 
   ...
   <!--         <li><?php echo anchor('c_berita','list berita');?></li>
	...
	<h3>Daftar Soal</h3>
			...
			<tr class="data">       
                ...
                <center>
                <a href="./c_soal/delete/<?php echo $row->id_soal ?>"><img src="<?php echo base_url(); ?>mos-css/img/oke.png"></a>&nbsp;&nbsp;&nbsp;
                <a href="./c_soal/edit/<?php echo $row->id_soal ?>"><img src="<?php echo base_url(); ?>mos-css/img/detail.png"></a>
                </center>
                </td>
			</tr>
                        <?php $i++;?>
