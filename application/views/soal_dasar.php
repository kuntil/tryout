<html lang="en">
    ...
    <body text="black" onload="countdown()">
    ...
    <div class="container-fluid">
      <div class="row-fluid">
          <?php echo form_open('c_pengerjaan/simpanDasar','name="form_soal" id="form_soal"')?>
          ...
          <div class="row-fluid">
              <ul class="thumbnails">
                  <li class="span4">
                      ...
                      <div class="thumbnail">
                          <h4 class="text-success"><center>Matematika</center></h4>
                      </div>
                      </a>
                  </li>
                  <li class="span4">
                      ...
                      <div class="thumbnail">
                          <h4 class="text-success"><center>Bahasa Indonesia</center></h4>
                      </div>
                      </a>
                  </li>                  
                  <li class="span4">
                      ...
                      <div class="thumbnail">
                          <h4 class="text-success"><center>Bahasa Inggris</center></h4>
                      </div>
                      </a>
                  </li>
              </ul>
                  ...
                  <li class="span12">
                      <div class="thumbnail">
                          <table cellpadding="10" rowpadding="10" class="table-striped">
                              <?php $i=1; foreach ($soal_mtk->result() as $row ) : ?>
                              <tr>
          ...
          <div class="row-fluid">
              <ul class="thumbnails">
                  <li class="span12">
                      <div class="thumbnail">
                          <table cellpadding="10" rowpadding="10" class="table-striped">
                              <?php $i=1; foreach ($soal_ind->result() as $row ) : ?>
                              <tr>
                                  <td valign=top><?php echo $i?></td>
                                  <td colspan="2"><?php echo $row->soal; ?></td>
                              </tr>
          ...
          <div class="row-fluid">
              <ul class="thumbnails">
                  <li class="span12">
                      <div class="thumbnail">
                          <table cellpadding="10" rowpadding="10" class="table-striped">
                              <?php $i=1; foreach ($soal_ing->result() as $row ) : ?>
                              <tr>
                                  <td valign=top><?php echo $i?></td>
                                  <td colspan="2"><?php echo $row->soal; ?></td>
                              </tr>
                              <tr>
                                  <td></td>
                                  <td><input type="radio" name="jawab[<?php echo $i+30?>]" value="a"> A</td>
                                  <td><?php echo $row->plh_a?></td>
                              </tr>
                              <tr>
                                  <td></td>
                              ...
                              <tr>
                                  ...
                                  <td></td>
                                  <td>
								  <input type="hidden" name="soal[<?php echo $i+30?>]" value="<?php echo $row->id_soal?>"/></td>
                              </tr>
                              <?php $i++; endforeach;?>
                          </table>
                      </div>
